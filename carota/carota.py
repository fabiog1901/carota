...
class FabGender:
    ...
    def generator(self):
        if gender is None:
            yield self.rd.choice(GENDER_LIST)
        else:
            yield GENDER_LIST[int(gender)]
